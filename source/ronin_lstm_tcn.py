    ...
    try:
        for epoch in range(start_epoch, args.epochs):
            ...
            if val_loader:
                ...
                # wandb.log({"epoch":epoch, "train loss": train_errs[epoch], "val loss":val_loss})
...
def test(args, **kwargs):
    ...
    for idx, data in enumerate(test_data_list):
        ...
        feat, vel, dpath = seq_dataset.get_test_seq(idx)
...
if __name__ == '__main__':
    ...
    # common
    parser.add_argument('--type', type=str, default='tcn', choices=['tcn', 'lstm', 'lstm_bi'], help='Model type')
    ...
    out_dir_lstm = './model/ronin_lstm/checkpoints/lstm'
    out_dir_tcn = './model/ronin_lstm/checkpoints/tcn'
    '''
    Extra arguments
    ...
    '''
    # train
    sys.argv = ['ronin_lstm_tcn.py', 'train',
                '--train_list', '../lists/list_train.txt', '--data_dir', '../data/ronin/train_dataset/',
                '--val_list', '../lists/list_val.txt', '--out_dir', out_dir_tcn, '--device', 'cuda:0']

    plots_lstm_test_seen = './test/lstm/seen'
    plots_lstm_test_unseen = './test/lstm/unseen'
    plots_tcn_test_seen = './test/tcn/seen'
    plots_tcn_test_unseen = './test/tcn/unseen'
    plots_tcn_test_ust = './test/tcn/ust'

    # lstm
    # model_path_lstm = './model/ronin_lstm/checkpoints/lstm/checkpoints/icheckpoint_999.pt'
    # test seen
    # sys.argv = ['ronin_lstm_tcn.py', 'test',
    #             '--test_list', '../lists/list_test_seen.txt', '--data_dir', '../data/ronin/seen_subjects_test_set',
    #             '--out_dir', plots_lstm_test_seen, '--device', 'cuda:0',
    #             '--model_path', model_path_lstm]
    # test unseen
    # sys.argv = ['ronin_lstm_tcn.py', 'test',
    #             '--test_list', '../lists/list_test_unseen.txt', '--data_dir', '../data/ronin/unseen_subjects_test_set',
    #             '--out_dir', plots_lstm_test_unseen, '--device', 'cuda:0',
    #             '--model_path', model_path_lstm]

    # tcn
    model_path = '../../ronin_tianlang/source/model/ronin_lstm/checkpoints/tcn/checkpoints/icheckpoint_199.pt'

    # test seen
    sys.argv = ['ronin_lstm_tcn.py', 'test',
                '--test_list', '../lists/list_test_seen.txt', '--data_dir', '../../ronin_tianlang/data/train_dataset',
                '--out_dir', plots_tcn_test_seen, '--device', 'cuda:0',
                '--model_path', model_path]
    # test unseen
    # sys.argv = ['ronin_lstm_tcn.py', 'test',
    #             '--test_list', '../lists/list_test_unseen.txt', '--data_dir', '../data/ronin/unseen_subjects_test_set',
    #             '--out_dir', plots_tcn_test_unseen, '--device', 'cuda:0',
    #             '--model_path', model_path_tcn]
